...
echo '<img src="img/usuario.png" class="user-image">';
  ...
  <aside class="main-sidebar">
      <section class="sidebar">
          <ul class="sidebar-menu">
            <!--  <li class="treeview" id="menu_li">
                  <a onclick=""><i class="fa fa-list-ul"></i><span>Matrix Dofa</span>
                      <span class="pull-right-container">
                          <i class="fa fa-angle-left pull-right"></i></span>
                  </a>
                  <ul class="treeview-menu">
                      <li><a  onclick=""><i class="fa fa-circle-o"></i><span>Introduccion</span></a></li>
                      <li><a  onclick=""><i class="fa fa-circle-o"></i><span>Aspectos principales</span></a></li>
                      <li><a  onclick=""><i class="fa fa-circle-o"></i><span>Caracteristicas Dofa</span></a></li>
                      <li><a  onclick=""><i class="fa fa-circle-o"></i><span>Practicas Dofa</span></a></li></ul>
              </li>-->
 ...
 $id_perfil= $_SESSION["id_perfil"];
   $guias = ControladorMenu::ctrconsultamenucursos($id_perfil);	
 
 echo $guias;*/
 ?>
 <?php 
 /*
 echo'<aside class="main-sidebar"><section class="sidebar"><ul class="sidebar-menu"><li class="treeview" id="menu_li"><a onclick="curso dofa"><i class="fa fa-list-ul"></i><span>Matrix Dofa</span><span class="pull-right-container"><i class="fa fa-angle-left pull-right"></i></span></a><ul class="treeview-menu"><li><a  onclick="introduccion"><i class="fa fa-circle-o"></i><span>Introduccion</span></a></li><li><a  onclick="aspectos principales"><i class="fa fa-circle-o"></i><span>Aspectos principales</span></a></li><li><a  onclick="Caracteristicas Dofa"><i class="fa fa-circle-o"></i><span>Caracteristicas Dofa</span></a></li><li><a  onclick="Practicas Dofa"><i class="fa fa-circle-o"></i><span>Practicas Dofa</span></a></li></ul></li></ul>
                                 </section> 
                                      </aside> ';
 */
 ?>
 ...
 <div class="content-wrapper">
  ...
  <section class="content-header">
    ...
    <h1>
      ...
      VERIFICADOR DE PRECIOS POS  <button class="btn btn-default btn-lg" onClick="cambio_clase()" id="buttone1"  >
