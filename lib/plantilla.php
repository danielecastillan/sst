...
<body class="hold-transition skin-blue sidebar-collapse sidebar-mini login-page">
  ...
  if(isset($_SESSION["iniciarSesion"]) && $_SESSION["iniciarSesion"] == "ok"){
   ...
   echo '<div class="wrapper">';
    ...
    include "Menu/vistas/cabezote.php";
//	include "modulos/cabezote.php";
    ...
    if(isset($_GET["ruta"])){
      ...
      if($_GET["ruta"] == "inicio" ||
        ...
        include "Menu/vistas/404.php";

      }

    }else{

      include "Menu/vistas/inicio.php";
    ...
    include "Menu/vistas/footer.php";

    echo '</div>';

  }else{

    include "Menu/vistas/login.php";
