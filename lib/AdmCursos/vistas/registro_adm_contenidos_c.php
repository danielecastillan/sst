...
<div class="content-wrapper">
  ...
  <section class="content-header">
    ...
    <h1>
      ...
      Registro de Contenido</h1>

    <ol class="breadcrumb">
      
      <li><a href="Central.php"><i class="fa fa-dashboard"></i> Inicio</a></li>
      
      <li class="active">Administracion de Contenido</li>
...
<form method="post" id="form_reg"   enctype="multipart/form-data" >
      ...
      <div class="box-header with-border">
        ...
        <div class="box-header with-border">
           ...
           <div class="form-row">
            ...
            <div class="form-group col-md-4">Adjuntar Video Leccion
              <input type="file" class="adjuntarVideo" name="adjuntarVideo" id="adjuntarVideo" >
            </div>
