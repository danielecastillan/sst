...
<div class="content-wrapper">
  ...
  <section class="content-header">
    ...
    <h1>
      ...
      Registro de Cursos</h1>

    <ol class="breadcrumb">
      
      <li><a href="Central.php"><i class="fa fa-dashboard"></i> Inicio</a></li>
      
      <li class="active">Administracion de Cursos</li>
...
<h3>
      ...
      <div class="box-header with-border">
           ...
           <div class="form-row">
            ...
            <div class="form-group col-md-4">Nombre del Curso
              <input type="text" class="form-control input-lg" id="nombre_curso" name="nombre_curso" placeholder="nombre del curso" >
            </div>
      ...
      <div class="box-header with-border">
        ...
        <div class="box-header with-border">
           ...
           <div class="form-row">
            ...
            <div class="form-group col-md-4">Descripcion del curso 
               
               
               <textarea class="form-control input-lg" id="descripcion_curso" rows="3"></textarea> 
            </div>
...
<div class="box-header with-border">
 ...
 <button class="btn btn-primary" onClick="registro_adm_curso()" >
      ...
      <div class="box-body">
        ...
        <div id="contenedor_consulta">
          <legend>Consulta Detalla De Curso</legend>
        ...
        <thead>
           ...
           <th  ><h4 class="display-3">Nombre de Curso</h4></th>
            <th><h4 class="display-3">Descripcion Curso</h4></th>
        <th><h4 class="display-3">Fecha de Creacion</h4></th>
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
        ...
        <div class="modal-header" style="background:#3c8dbc; color:white">
          ...
          <h4 class="modal-title">Editar Estado de Curso</h4>
