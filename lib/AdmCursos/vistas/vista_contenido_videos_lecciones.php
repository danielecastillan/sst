  <?php 
  $id_contenido_leccion=$_POST['id_contenido_leccion'];
  $nombre=$_POST['nombre'];
  $descripcion_fun=$_POST['descripcion_fun'];
...
<h3><?php echo $nombre;?></h3>
          ...
          <label>
<h4><b>Descripcion:</b><?php echo $descripcion_fun;?></h4>
      </label>
            </div>
      ...
      <div class="box-header with-border">
       ...
       <center> <video   controls src="<?php echo $ruta_video;?>"  width="640" height="400" poster="img/lec.jpg" align="center"></video></center>
