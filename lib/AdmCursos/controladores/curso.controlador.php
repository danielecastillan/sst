...
//require_once 'lib/Menu/modelos/cursos.modelo.php';
...
//($numero_producto, $nombre_producto, $punto_venta, $contador);
		return $respuesta;
           	...
           	static public function ctrMostrarConsultasCursos(){
 
		$tabla = "productos";

		$respuesta = ModeloCursos::mdlMostrarConsultasCursos();
//($numero_producto, $nombre_producto, $punto_venta, $contador);
		return $respuesta;

	}
        
           	static public function ctrMostrarConsultasModulos(){
 
		$tabla = "productos";

		$respuesta = ModeloCursos::mdlMostrarConsultasModulos();
//($numero_producto, $nombre_producto, $punto_venta, $contador);
		return $respuesta;
                	...
                	static public function ctrMostrarConsultasCursosInscritos(){
 
		$tabla = "productos";

		$respuesta = ModeloCursos::mdlMostrarConsultasCursosInscritos();
//($numero_producto, $nombre_producto, $punto_venta, $contador);
		return $respuesta;
              	...
              	static public function ctrMostrarConsultasLecciones(){
 
		$tabla = "productos";

		$respuesta = ModeloCursos::mdlMostrarConsultasLecciones();
//($numero_producto, $nombre_producto, $punto_venta, $contador);
		return $respuesta;
        	...
        	static public function ctrMostrarConsultasUsuarios(){
 
		$tabla = "productos";

		$respuesta = ModeloCursos::mdlMostrarConsultasUsuarios();
//($numero_producto, $nombre_producto, $punto_venta, $contador);
		return $respuesta;

	}
              	static public function ctrMostrarConsultasanexoDocs(){
 
		$tabla = "productos";

		$respuesta = ModeloCursos::mdlMostrarConsultasanexoDocs();
//($numero_producto, $nombre_producto, $punto_venta, $contador);
		return $respuesta;
           	...
           	static public function ctrMostrarConsultasPerfil(){
 
		$tabla = "productos";

		$respuesta = ModeloMenu::mdlMostrarConsultasPerfilConsul();
//($numero_producto, $nombre_producto, $punto_venta, $contador);
		return $respuesta;
...
//($numero_producto, $nombre_producto, $punto_venta, $contador);
	...
	static public function ctrMostrarGuias($item, $valor, $orden){
        ...
        static public function ctrconsultamenucursos($id_perfil){

		$tabla = "productos";
		$respuesta = ModeloMenu::mdlconsultamenucursos($id_perfil);
