...
//($numero_producto, $nombre_producto, $punto_venta, $contador);
		...
		$respuesta = ModeloCursos::mdlMostrarConsultasMenuBasico();
//($numero_producto, $nombre_producto, $punto_venta, $contador);
		return $respuesta;
...
//($numero_producto, $nombre_producto, $punto_venta, $contador);
	...
	static public function ctrMostrarGuias($item, $valor, $orden){
        ...
        static public function ctrconsultamenucursos($item, $valor, $orden){

		$tabla = "productos";

		$respuesta = ModeloGuias::mdlconsultamenucursos($tabla, $item, $valor, $orden);
