 ...
 */
  ...
  <script>
    $(document).ready(function () {
     consulta_central_PTV(<?php  echo $_SESSION["id_punto_venta"]; ?>);
   //  alert("alerta de prueba consulta pedidos");
   consulta_punto_venta_pedido();
   consulta_punto_venta_pedido_facturado();
   
   
consulta_nombre_punto_venta(<?php  echo $_SESSION["id_punto_venta"]; ?>)
   
   setInterval(consulta_central_PTV(<?php  echo $_SESSION["id_punto_venta"]; ?>), 30000);
...
<div class="content-wrapper">
  ...
  <section class="content">
    ...
    <div class="box">
      ...
      <div id="div_pnt_vent">Punto de Venta</div></h3>
...
--> 
            <div class="form-group col-md-4">
             ...
             <input type="checkbox" id="check_fac_electronica" value="1" readonly  onclick="javascript: return false;"/>
 ...
 <div class="form-group col-md-4">
  ...
  <input type="text" class="form-control input-lg" id="forma_entrega" name="forma_entrega" placeholder="Nombre Vendedor" readonly>
  ...
  <input type="text" class="form-control input-lg" id="numero_factura" name="numero_factura" placeholder="Numero de Factura" >
    ...
    <button class="btn btn-primary" onClick="modificar_adicion_factura_pedido_pvt(<?php  echo $_SESSION["id_punto_venta"]; ?>)" id="bot_fac_on" style="display:none">
...
<div id="contenedor_consulta">
   ...
   <div id="bloque_formulario_pedido" style="display:bloc">
            ...
            <div class="form-group col-md-4">
             ...
             <input type="checkbox" id="check_fac_electronica_fac" value="1" readonly  onclick="javascript: return false;"/>
