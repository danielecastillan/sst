			...
			if (empty($productos[$i]["imagen"])) 
			{
  			...
  			if(isset($_GET["perfilOculto"]) && $_GET["perfilOculto"] == "Especial"){
  				...
  				$botones =  "<div class='btn-group'><button class='btn btn-warning btnEditarProducto' idProducto='".$productos[$i]["id"]."' data-toggle='modal' data-target='#modalEditarProducto'><i class='fa fa-pencil'></i></button></div>"; 
  				 ...
  				 $botones =  "<div class='btn-group'><button class='btn btn-info btnEditarProducto' idProducto='".$productos[$i]["id"]."' data-toggle='modal' data-target='#modalEditarProducto'><i class='fa fa-search'></i></button></div>"; 
