...
require_once "../controladores/ciiu.controlador.php";
...
class TablaGuias{
 ...
 /*
  		...
  		$guias = ControladorCiiu::ctrMostrarCiiuCompuestoTabla();	
   ...
   $arreglo_retorno = array();
    ...
    $botones =  "<div class='btn-group'><button class='btn btn-warning btnEditarProducto'   onclick='eliminar_registro_com_ciiu(". $concat.$guias[$i]["COD_RCIIU"].$concat .")'  ><i class='fa fa-times'></i></button><button class='btn btn-warning btnEditarProducto'   onclick='edicion_registro_ciiu(". $concat.$guias[$i]["COD_RCIIU"].$concat .",". $concat.$guias[$i]["ARB_CONT"].$concat .",". $concat.$guias[$i]["ARB_CODI"].$concat .",". $concat.$guias[$i]["ARB_NOMB"].$concat .",". $concat.$guias[$i]["COD_CIIU"].$concat .",". $concat.$guias[$i]["nombre_codigo"].$concat .",". $concat.$guias[$i]["TARIFA"].$concat .",". $concat.$guias[$i]["CODIGO_ALCALDIA"].$concat .",". $concat.$guias[$i]["DTS_CODI"].$concat .",". $concat.$guias[$i]["DST_NOMB"].$concat .")'  ><i class='fa fa-pencil-square-o'></i></button></div>"; 
              ...
              /*
                 ...
                 $arreglo_interior = array( $botones,$guias[$i]["ARB_CONT"] ,
                    $guias[$i]["ARB_CODI"]    , 
                    $guias[$i]["ARB_NOMB"]    , 
                    $guias[$i]["COD_CIIU"]    , 
                    $guias[$i]["nombre_codigo"]    , 
                    $guias[$i]["TARIFA"]    , 
                    $guias[$i]["CODIGO_ALCALDIA"]    , 
                    $guias[$i]["DTS_CODI"]    , 
                    $guias[$i]["DST_NOMB"]    
