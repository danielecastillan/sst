   ...
   $arreglo_retorno = array();
		  for($i = 0; $i <  count($guias); $i++){
  		 ...
  		 //   $botones =  "<div class='btn-group'><button class='btn btn-warning btnEditarProducto'   onclick='eliminar_registro_perfil(". $concat.$guias[$i]["id_perfil"].$concat .")'  ><i class='fa fa-times'></i></button></div>"; 
              ...
              $botones =  "<div class='btn-group'><button class='btn btn-warning btnEditarProducto' onclick='traspaso_variables_sucursal(". $concat.$guias[$i]["ARB_CONT"].$concat ."," . $concat . $guias[$i]["ARB_CODI"] . $concat . "," . $concat . $guias[$i]["ARB_NOMB"] . $concat . ")'><i class='fa fa-hand-o-up'></i></button></div>"; 
            ...
            */
              ...
              $arreglo_interior = array(   $botones  ,$guias[$i]["ARB_CODI"] ,
                    $guias[$i]["ARB_NOMB"]     
