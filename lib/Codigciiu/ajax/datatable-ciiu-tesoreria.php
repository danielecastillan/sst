   ...
   $arreglo_retorno = array();
		  for($i = 0; $i <  count($guias); $i++){
  		 ...
  		 //   $botones =  "<div class='btn-group'><button class='btn btn-warning btnEditarProducto'   onclick='eliminar_registro_perfil(". $concat.$guias[$i]["id_perfil"].$concat .")'  ><i class='fa fa-times'></i></button></div>"; 
              ...
              $botones =  "<div class='btn-group'><button class='btn btn-warning btnEditarProducto' onclick='traspaso_variables_tesoreria(". $concat.$guias[$i]["DST_CODI"].$concat ."," . $concat . $guias[$i]["DST_NOMB"] . $concat . ")'><i class='fa fa-hand-o-up'></i></button></div>"; 
            ...
            */
              ...
              $arreglo_interior = array(   $botones  ,$guias[$i]["DST_CODI"] ,
                    $guias[$i]["DST_NOMB"]     
