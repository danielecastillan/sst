   ...
   $arreglo_retorno = array();
		  for($i = 0; $i <  count($guias); $i++){
  		 ...
  		 //   $botones =  "<div class='btn-group'><button class='btn btn-warning btnEditarProducto'   onclick='eliminar_registro_perfil(". $concat.$guias[$i]["id_perfil"].$concat .")'  ><i class='fa fa-times'></i></button></div>"; 
              ...
              $botones =  "<div class='btn-group'><button class='btn btn-warning btnEditarProducto' onclick='traspaso_variables_ciiu(". $concat.$guias[$i]["codigo_ciiu"].$concat ."," . $concat . $guias[$i]["nombre_codigo"] . $concat . ")'><i class='fa fa-hand-o-up'></i></button></div>"; 
            ...
            */
              ...
              $arreglo_interior = array(   $botones  ,$guias[$i]["codigo_ciiu"] ,
