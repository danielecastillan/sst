...
<div class="content-wrapper">
  ...
  <section class="content">
    ...
    <div class="box">
        ...
        <button class="btn btn-default btn-lg" onClick="conf_ciiu()" id="buttone1"  >
...
<input type="hidden" value="" id="HD_ARB_CONT" />
 <input type="hidden" value="" id="COD_RCIIU" />
 ...
 <button class="btn btn-primary" onClick="edicion_r_ciiu_det()" >
