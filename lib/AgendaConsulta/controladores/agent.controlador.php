<?php
require_once '../modelos/agent.modelo.php';
class ControladorAgent{
	...
	=============================================*/
       	...
       	static public function ctrMostrarConsultasMenuPerfil(){
 
		$tabla = "productos";

		$respuesta = ModeloMenu::mdlMostrarConsultasMenuPerfil();
...
//($numero_producto, $nombre_producto, $punto_venta, $contador);
		return $respuesta;
           	...
           	static public function ctrMostrarConsultasAgentTiempo($fecha,$user,$contador){
 
		$tabla = "productos";

		$respuesta = ModeloAgent::mdlMostrarConsultasConsulTiempo($fecha,$user,$contador);
//($numero_producto, $nombre_producto, $punto_venta, $contador);
		return $respuesta;
...
//($numero_producto, $nombre_producto, $punto_venta, $contador);
		return $respuesta;
          	...
          	static public function ctrMostrarConsultasAgentTerceros($fecha,$user,$contador){
 
		$tabla = "productos";

		$respuesta = ModeloAgent::mdlMostrarConsultasConsulTerceros($fecha,$user,$contador);
//($numero_producto, $nombre_producto, $punto_venta, $contador);
		return $respuesta;

	}
        
           	static public function ctrMostrarConsultasConsulActiEtapa($fecha,$contador,$user){
 
		$tabla = "productos";

		$respuesta = ModeloAgent::mdlMostrarConsultasConsulActiEtapa($fecha,$contador,$user);
//($numero_producto, $nombre_producto, $punto_venta, $contador);
		return $respuesta;
                	...
                	static public function ctrMostrarConsultasConsulConsolidado($fecha,$user,$contador){
 
		$tabla = "productos";

		$respuesta = ModeloAgent::mdlMostrarConsolidado($fecha,$user,$contador);
//($numero_producto, $nombre_producto, $punto_venta, $contador);
		return $respuesta;
           	...
           	static public function ctrValidaActividad($fecha){
 
		$tabla = "productos";

		$respuesta = ModeloAgent::mdlMostrarValidaActividad($fecha);
//($numero_producto, $nombre_producto, $punto_venta, $contador);
		return $respuesta;

	}
        
        	static public function ctrValidaActividadEtapa($eta_codi,$ACT_CODI){
 
		$tabla = "productos";

		$respuesta = ModeloAgent::mdlMostrarValidaActividadEtapa($eta_codi,$ACT_CODI);
//($numero_producto, $nombre_producto, $punto_venta, $contador);
		return $respuesta;
              	...
              	static public function ctrMostrarConsultasHorasOM($NUM_ORDEN){
 
		$tabla = "productos";

		$respuesta = ModeloHoras::mdlMostrarConsultasHoraOM($NUM_ORDEN);
//($numero_producto, $nombre_producto, $punto_venta, $contador);
		return $respuesta;
