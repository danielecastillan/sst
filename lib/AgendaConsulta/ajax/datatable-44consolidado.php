...
class TablaGuias{
 ...
 /*
         ...
         $contador=$_POST['contador'];       
  		...
  		$guias = ControladorAgent::ctrMostrarConsultasConsulConsolidado($fecha,$user,$contador);	
		  ...
		  for($i = 0; $i < count($guias); $i++){
           ...
           /*
              ...
              7 ,
                ...
                *//*errores_consulta_agenda.usuario as ,count(*) as ,errores_consulta_agenda. as nombre_usuario*/
                 
                
                        $arreglo_interior = array(  $guias[$i]["nombre_usuario"]    ,
                            $guias[$i]["usuario"] ,
                     
                    "<div  align='center'>".$guias[$i]["cantidad"]."</div>"
