     ...
     static public function mdlEliminarMenuBasico($data){
      ...
      static public function mdlconsultamenu($data){
		...
		$stmt = null;
             ...
             static public function mdlconsultamenucursosv2($id_perfil,$id_curso){
                 ...
                 //   $constock.='<aside class="main-sidebar">';
                  ...
                  // $constock.='<ul class="sidebar-menu">';
                   ...
                   //primera consulta recorrido
                   $consultas_tmt = Conexion::conectar()->prepare("     
                                                                         SELECT modulos.`id_curso`,modulos.`id_modulo`,modulos.`nombre_modulo` FROM modulos
                                                                        WHERE
                  ...
                  for($i = 0; $i < count($stmtaudprerr); $i++){
                       ...
                       $nombre=$stmtaudprerr[$i]['nombre_modulo'];
                       $descripcion_fun=$stmtaudprerr[$i]['nombre_modulo'];
                  ...
                  $consultas_tmt22 = Conexion::conectar()->prepare("     
                                 ...
                                 SELECT leccion_contenido.`id_modulo`,leccion_contenido.`id_contenido_leccion`,leccion_contenido.`nombre_leccion`,leccion_contenido.descripcion,leccion_contenido.ruta_video
                  ...
                  $stmtaudprerr22= $consultas_tmt22 ->fetchAll();
                    $constockdet.='<ul class="treeview-menu">';
                  for($ii = 0; $ii < count($stmtaudprerr22); $ii++){
                    $nombre22=$stmtaudprerr22[$ii]['nombre_leccion'];
                    $descripcion_fun22=$stmtaudprerr22[$ii]['descripcion'];
                    $id_contenido_leccion22=$stmtaudprerr22[$ii]['id_contenido_leccion'];
                    $ruta_video22=$stmtaudprerr22[$ii]['ruta_video'];
                    
                    
                    $concat='"';
                    
                      $constockdet.='<li>';
                      $constockdet.="<a  onclick='consul_vista_contenido_lecciones(".$concat.$id_contenido_leccion22.$concat.",".$concat.$nombre22.$concat.",".$concat.$descripcion_fun22.$concat.",".$concat.$ruta_video22.$concat.")'>";
                      $constockdet.='<i class="fa fa-circle-o"></i>';
                      $constockdet.='<span>'.$nombre22.'</span>';
                      $constockdet.='</a>';
                      $constockdet.='</li>';
		      ...
		      $constock.= '</span>';
                  ...
                  */
                  ...
                  $id_curso=1; 
                 $consultas_link_curso = Conexion::conectar()->prepare("  SELECT * FROM link_curso 
                                                                          where id_curso=$id_curso
                                                                            LIMIT 1 ");
                  $consultas_link_curso -> execute();
                  $det_link_curso= $consultas_link_curso ->fetch();
                  
                  
                  $id_curso_det=$det_link_curso['id_curso'];
                  $url_curso_det=$det_link_curso['url_curso'];
                   $linkstock='';
                  if($id_curso==$id_curso_det){
                      
                   $linkstock.='<li class="treeview">';
                   $linkstock.= "<a onclick='consul_vista_contenido_link(".$concat.$id_curso_det.$concat.",".$concat.$url_curso_det.$concat.")'>";
                   $linkstock.= '<i class="fa fa-list-ul"></i>'; 
                   $linkstock.= '<span>Descarga de curso</span>'; 
                   $linkstock.= '<span class="pull-right-container">';
	  ...
	  static public function mdlconsultanombrecurso($id_curso){
                   ...
                   $consultas_tmt = Conexion::conectar()->prepare("     
                                                                        ...
                                                                        cursos.`id_curso`=$id_curso 
                                                                         ...
                                                                         ");
                  $consultas_tmt -> execute();
                  $stmtaudprerr= $consultas_tmt ->fetch();
                   $nombre_curso=$stmtaudprerr['nombre_curso'];
