...
//($numero_producto, $nombre_producto, $punto_venta, $contador);
	...
	static public function ctrMostrarGuias($item, $valor, $orden){
		...
		return $respuesta;
         ...
         static public function ctrconsultamenucursosv2($id_perfil,$id_curso){

		$tabla = "productos";
		$respuesta = ModeloMenu::mdlconsultamenucursosv2($id_perfil,$id_curso);
		...
		return $respuesta;
          ...
          static public function ctrconsultanombrecurso($id_curso){

		$tabla = "productos";
		$respuesta = ModeloMenu::mdlconsultanombrecurso($id_curso);
