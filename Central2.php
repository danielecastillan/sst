...
<header class="main-header" style="background-color:#3a306e">
 ...
 <div id="div_con_menu"></div>
  <aside class="main-sidebar">
	 ...
	 <section class="sidebar">
		...
		if($_SESSION["perfil"] == "administrador" || $_SESSION["perfil"] == "consulta"){
	...
	echo '<li class="treeview">
				...
				<ul class="treeview-menu">
					...
					<li>
						...
						<a  onclick="guias_generadas()">
							
							<i class="fa fa-circle-o"></i>
							<span>Guias y Despachos</span>
	...
	echo '<li class="treeview">
				...
				<ul class="treeview-menu">
					...
					<li>
						...
						<a  onclick="consulta_contapyme()">
							
							<i class="fa fa-circle-o"></i>
							<span>Contapyme 2015</span>
