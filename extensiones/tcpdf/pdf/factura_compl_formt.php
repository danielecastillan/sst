...
$pedid = ControladorProd::ctrMostrarPedidosIIndividualDetalladoPdfEst($tra_cont);	
...
$prefijo=$pedid['TRA_PREF'];
$no_factura=$pedid['TRA_DIAN'];
$fecha_factura=$pedid['FECH_FAC_FIN'];
...
$bloque2 = <<<EOF
	...
	<table style="font-size:10px; padding:5px 10px;">
                  ...
                  <tr>
                   <td  colspan="3" style="border: 1px solid #666; background-color:white;  ">
                   <table>
                    <tr><td colspan="2" style="text-align:center"><center>$nombre_cliente</center></td></tr>
                    <tr><td>&nbsp;</td></tr> 
